...
load File.expand_path("../../coordinators/instrument_coordinator.rb", __FILE__)
...
Elaine::Spec::InstrumentCoordinator.supervise_as :coordinator, partitioner: Elaine::Distributed::MD5Partitioner
sleep
