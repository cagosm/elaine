...
module CoordinatorInstrumentCoordinator
  PORT = 8090
  def self.start
    @@pid = Process.spawn Gem.ruby, File.expand_path("../../nodes/coordinator_instrument_coordinator_node.rb", __FILE__)
...
module CoordinatorInstrumentWorker1
  PORT = 8091
  def self.start
...
module CoordinatorInstrumentWorker2
  PORT = 8092
  def self.start
